...
class TestsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create test" do
    assert_difference('Test.count') do
      post tests_url, params: { test: { email: @test.email, login: @test.login, name: @test.name } }
    end
  ...
  test "should update test" do
    patch test_url(@test), params: { test: { email: @test.email, login: @test.login, name: @test.name } }
